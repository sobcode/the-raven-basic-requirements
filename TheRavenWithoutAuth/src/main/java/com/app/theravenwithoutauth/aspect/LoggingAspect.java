package com.app.theravenwithoutauth.aspect;
...
public class LoggingAspect {
     ...
     */
    @Pointcut("execution(* com.app.theravenwithoutauth..*.*(..)) " +
            "&& !execution(* com.app.theravenwithoutauth..ControllerExceptionHandler.*(..)) " +
